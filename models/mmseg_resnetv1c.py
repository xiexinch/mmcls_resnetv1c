    ...
    def __init__(self,
        ...
        if stride != 1 or inplanes != planes * block.expansion:
            ...
            if avg_down:
                ...
                downsample.add_module(
                    name='1',
                    module=build_norm_layer(norm_cfg,
...
@MODELS.register_module(name='MMSegResNet')
...
@MODELS.register_module(name='MMSegResNetV1c')
...
@MODELS.register_module(name='MMSegResNetV1d')
